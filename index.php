...
<!-- Mirrored from wrappixel.com/demos/admin-templates/material-pro/material/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Feb 2019 00:07:43 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="fix-header fix-sidebar card-no-border" ng-app="App">
    <!-- ============================================================== -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-laptop-windows"></i><span class="hide-menu">Empreendimento</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="#!empreendimento-new">Cadastrar</a></li>
                                <li><a href="#!empreendimento-list">Listar</a></li>
...
<!-- Mirrored from wrappixel.com/demos/admin-templates/material-pro/material/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Feb 2019 00:07:50 GMT -->
</html>